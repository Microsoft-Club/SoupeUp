//! Built-in Dask example jobs — Python bodies live in sibling `.py` files.
//! Each file documents its package dependencies in a header comment.

/// Metadata for a zero-code demo job shown in the Cluster UI.
pub struct ExampleSpec {
    ...
    /// Extra pip packages beyond the Dask plugin baseline (`numpy`, etc.).
...
pub fn list() -> &'static [ExampleSpec] {
    ALL_EXAMPLES
}

/// Example job ready to execute.
